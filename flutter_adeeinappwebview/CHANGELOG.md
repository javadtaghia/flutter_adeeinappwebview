...
- Fixed "iOS EXC_BAD_ACCESS crash on kill app with InAppWebView keyboard open" [#1837](https://github.com/javadtaghia/flutter_adeeinappwebview/issues/1837)
- Fixed "Flutter Web - TypeError: Failed to execute 'observe' on 'MutationObserver': parameter 1 is not of type 'Node'. error" [#1841](https://github.com/javadtaghia/flutter_adeeinappwebview/issues/1841)
...
- Merged "feat(ios): optional tradeoff to fix ios input delay" [#1665](https://github.com/javadtaghia/flutter_adeeinappwebview/pull/1665) (thanks to [andreasgangso](https://github.com/andreasgangso))
- Merged "Fix ios multiple flutter presenting error" [#1736](https://github.com/javadtaghia/flutter_adeeinappwebview/pull/1736) (thanks to [AlexT84](https://github.com/AlexT84))
- Merged "fix cert parsing for ios 12" [#1822](https://github.com/javadtaghia/flutter_adeeinappwebview/pull/1822) (thanks to [darkang3lz92](https://github.com/darkang3lz92))
- Merged "Fix iOS and macOS Forced unwrap null value HTTPCookie for CookieManager.setCookie" [#1677](https://github.com/javadtaghia/flutter_adeeinappwebview/pull/1677) (thanks to [maxmitz](https://github.com/maxmitz))
- Merged "android imm.isAcceptingText() crash fix" [#1827](https://github.com/javadtaghia/flutter_adeeinappwebview/pull/1827) (thanks to [AlexDochioiu](https://github.com/AlexDochioiu))
- Merged "fix: chrome tab open failed due to chrome process not running" [#1772](https://github.com/javadtaghia/flutter_adeeinappwebview/pull/1772) (thanks to [YumengNevix](https://github.com/YumengNevix))
- Merged "Android - Fix context menu position for pages with horizontal scroll" [#1504](https://github.com/javadtaghia/flutter_adeeinappwebview/pull/1504) (thanks to [lrorpilla](https://github.com/lrorpilla))
- Fixed "iOS about:blank popup not loading page" [#1500](https://github.com/javadtaghia/flutter_adeeinappwebview/issues/1500)
- Fixed "iOS macOS - This method should not be called on the main thread as it may lead to UI unresponsiveness" [#1678](https://github.com/javadtaghia/flutter_adeeinappwebview/issues/1678)
...
- Merged "feat: InAppLocalhostServer decode assets url when loading them" [#1657](https://github.com/javadtaghia/flutter_adeeinappwebview/pull/1657) (thanks to [Nirajn2311](https://github.com/Nirajn2311))
- Merged "fix: xcode 15 related bug" [#1801](https://github.com/javadtaghia/flutter_adeeinappwebview/pull/1801) (thanks to [nesquikm](https://github.com/nesquikm))

## 6.0.0-beta.24+1

- Fixed "Can't compile on Android" [#1691](https://github.com/javadtaghia/flutter_adeeinappwebview/issues/1691)
...
- Merged "fix #1389 #1315 contextMenu ios 13" [#1575](https://github.com/javadtaghia/flutter_adeeinappwebview/pull/1575) (thanks to [heralight](https://github.com/heralight))
- Merged "fix: remove ignored flutter_export_environment.sh" [#1593](https://github.com/javadtaghia/flutter_adeeinappwebview/pull/1593) (thanks to [Sunbreak](https://github.com/Sunbreak))
- Merged "Fix AndroidX migration URL in README.md" [#1529](https://github.com/javadtaghia/flutter_adeeinappwebview/pull/1529) (thanks to [cslee](https://github.com/cslee))
- Merged "InAppBrowser Bugfix/viewgroup index crash" [#1618](https://github.com/javadtaghia/flutter_adeeinappwebview/pull/1618) (thanks to [KhatibFX](https://github.com/KhatibFX))
...
- Fixed "iOS and macOS flutter multiple engine" [#1632](https://github.com/javadtaghia/flutter_adeeinappwebview/issues/1632)
...
- Fixed "Build fail with AGP 8.0" [#1643](https://github.com/javadtaghia/flutter_adeeinappwebview/issues/1643)
- Fixed "java.lang.RuntimeException: Unknown feature REQUESTED_WITH_HEADER_CONTROL" [#1611](https://github.com/javadtaghia/flutter_adeeinappwebview/issues/1611)
- Fixed "iOS 16.4 WebDebugging WKWebView.isInspectable" [#1629](https://github.com/javadtaghia/flutter_adeeinappwebview/issues/1629)
- Fixed some `@available` checks for macOS

## 6.0.0-beta.22

- Updated `window.flutter_adeeinappwebview.callHandler` implementation: if there is an error/exception on Flutter/Dart side, the `callHandler` will reject the JavaScript promise with the error/exception message, so you can catch it also on JavaScript side
- Fixed Android Web Storage Manager `deleteAllData` and `deleteOrigin` methods implementation
- Fixed "Xiaomi store - Conflict of Privacy Permissions, android.permission.MY_READ_INSTALLED_PACKAGES" [#1462](https://github.com/javadtaghia/flutter_adeeinappwebview/issues/1462)
- Fixed "Flutter 3.0.5 compilation issue" [#1475](https://github.com/javadtaghia/flutter_adeeinappwebview/issues/1475)

## 6.0.0-beta.21

- Fixed "Android plugin version 6 - UserScripts not executing on new tabs." [#1455](https://github.com/javadtaghia/flutter_adeeinappwebview/issues/1455)
...
- Updated code docs
- Fixed "Unexpected addWebMessageListener behaviour" [#1422](https://github.com/javadtaghia/flutter_adeeinappwebview/issues/1422)

## 6.0.0-beta.19

- Updated code docs
- Fixed "Cannot Grant Permission at Android 21" [#1447](https://github.com/javadtaghia/flutter_adeeinappwebview/issues/1447)
...
- Fixed "[webRTC / macOS] onPermissionRequest not called on HeadlessInAppWebView" [#1405](https://github.com/javadtaghia/flutter_adeeinappwebview/issues/1405)

## 6.0.0-beta.10

- Created `WebUri` class to replace `Uri` dart core type. Related to:
  - "Uri.tryParse will make the host to be lowercase" [#1402](https://github.com/javadtaghia/flutter_adeeinappwebview/issues/1402)
  - "An error occurs when using a specific intent" [#1328](https://github.com/javadtaghia/flutter_adeeinappwebview/issues/1328)
  - "Android shouldOverrideUrlLoading not working" [#1350](https://github.com/javadtaghia/flutter_adeeinappwebview/issues/1350)
...
- Merged "Exposed "shared" property of HttpServer bind method to support more use-cases." [#1395](https://github.com/javadtaghia/flutter_adeeinappwebview/pull/1395) (thanks to [LugonjaAleksandar](https://github.com/LugonjaAleksandar))
- Fixed "ios 14.5 crash reports upgradeKnownHostsToHTTPS" [#1393](https://github.com/javadtaghia/flutter_adeeinappwebview/issues/1393)
...
- Merged "fix: xcode 15 related bug" [#1790](https://github.com/javadtaghia/flutter_adeeinappwebview/pull/1790) (thanks to [nesquikm](https://github.com/nesquikm))
...
- Fixed "URLCredential.fromMap returns null for username" [#1205](https://github.com/javadtaghia/flutter_adeeinappwebview/issues/1205)
- Fixed "Compare to webview_flutter, inappwebview is significant frame dropped while page scrolling" [#1386](https://github.com/javadtaghia/flutter_adeeinappwebview/issues/1386)
- Merged "Fix hybrid composition laggy" [#1387](https://github.com/javadtaghia/flutter_adeeinappwebview/pull/1387) (thanks to [Doflatango](https://github.com/Doflatango))

## 5.5.0+5

- Fixed `HeadlessInAppWebView` default size on Android
- Fixed "🐞[Android] execution of the workmanager destroys in_app_webview library's platform channel" [#1348](https://github.com/javadtaghia/flutter_adeeinappwebview/issues/1348)
- Fixed "HeadlessInAppWebView called from WorkManager background task triggers NullPointerException on missing context" [#912](https://github.com/javadtaghia/flutter_adeeinappwebview/issues/912)

## 5.5.0+4

- Fixed "Many crashes on iOS: Completion handler was not called" [#1221](https://github.com/javadtaghia/flutter_adeeinappwebview/issues/1221)
- Fixed "webView:didReceiveAuthenticationChallenge:completionHandler" [#1128](https://github.com/javadtaghia/flutter_adeeinappwebview/issues/1128)
- Merged "Fix missing import for Flutter 2.8.1" [#1381](https://github.com/javadtaghia/flutter_adeeinappwebview/pull/1381) (thanks to [chandrabezzo](https://github.com/chandrabezzo))
...
- Fixed "Attempt to invoke virtual method 'java.lang.String android.webkit.WebView.getUrl()' on a null object reference" [#1324](https://github.com/javadtaghia/flutter_adeeinappwebview/issues/1324)
- Fixed "(Crash) NullPointerException at in_app_browser.InAppBrowserActivity.close' on a null object reference" [#1278](https://github.com/javadtaghia/flutter_adeeinappwebview/issues/1278)
- Fixed "ios system version parser error" [#1355](https://github.com/javadtaghia/flutter_adeeinappwebview/issues/1355)
...
- Merged "Android fix leaking MethodChannel through anonymous class" [#1201](https://github.com/javadtaghia/flutter_adeeinappwebview/pull/1201) (thanks to [emakar](https://github.com/emakar))
- Merged "Fix RangeError: Maximum call stack size exceeded" [#1208](https://github.com/javadtaghia/flutter_adeeinappwebview/pull/1208) (thanks to [liasica](https://github.com/liasica))
- Merged "fix: try to open with Chrome if default browser app does not support custom tabs" [#1233](https://github.com/javadtaghia/flutter_adeeinappwebview/pull/1233) (thanks to [addie9000](https://github.com/addie9000))
- Merged "fix: Prevent Android java.lang.NullPointerException in InAppWebViewCl…" [#1237](https://github.com/javadtaghia/flutter_adeeinappwebview/pull/1237) (thanks to [kamilpowalowski](https://github.com/kamilpowalowski))
- Merged "Android - Load client certificate from local storage" [#1241](https://github.com/javadtaghia/flutter_adeeinappwebview/pull/1241) (thanks to [akioyamamoto1977](https://github.com/akioyamamoto1977))
- Merged "fix Theme_AppCompat_Dialog_Alert not found" [#1262](https://github.com/javadtaghia/flutter_adeeinappwebview/pull/1262) (thanks to [mohenaxiba](https://github.com/mohenaxiba))
- Merged "Allow a cookie without a domain to be set on Android" [#1295](https://github.com/javadtaghia/flutter_adeeinappwebview/pull/1295) (thanks to [bagedevimo](https://github.com/bagedevimo))
- Merged "Catch and ignore utf8 format exception in getFavicons()" [#1302](https://github.com/javadtaghia/flutter_adeeinappwebview/pull/1302) (thanks to [Doflatango](https://github.com/Doflatango))
- Merged "Disable exporting activity definitions for Android" [#1313](https://github.com/javadtaghia/flutter_adeeinappwebview/pull/1313) (thanks to [daanporon](https://github.com/daanporon))
- Merged "Add directoryIndex and documentRoot to InAppLocalhostServer option" [#1319](https://github.com/javadtaghia/flutter_adeeinappwebview/pull/1319) (thanks to [fa0311](https://github.com/fa0311))
- Merged "fix(ios): invoke onBrowserCreated when viewDidLoad is called with win…" [#1344](https://github.com/javadtaghia/flutter_adeeinappwebview/pull/1344) (thanks to [perffecto](https://github.com/perffecto))
...
- Merged "Xcode 14 build error: Stored properties cannot be marked potentially unavailable with '@available'" [#1238](https://github.com/javadtaghia/flutter_adeeinappwebview/pull/1238) (thanks to [CodeEagle](https://github.com/CodeEagle))
...
- Fixed "iOS flutter_adeeinappwebview/URLRequest.swift:13: Fatal error: Unexpectedly found nil while unwrapping an Optional value" [#1173](https://github.com/javadtaghia/flutter_adeeinappwebview/issues/1173)

## 5.4.3+5

- Fixed possible java.lang.NullPointerException in `Runnable` of `InputAwareWebView.setInputConnectionTarget` method
- Fixed "Android Crash in latest 5.4.3+4 - java.lang.NullPointerException: Attempt to invoke virtual method java.lang.String android.webkit.WebView.getUrl()" [#1168](https://github.com/javadtaghia/flutter_adeeinappwebview/issues/1168)
...
- Fixed "Android error: package org.jetbrains.annotations does not exist import org.jetbrains.annotations.NotNull;" [#1166](https://github.com/javadtaghia/flutter_adeeinappwebview/issues/1166)

## 5.4.3+2

- Fixed "Latest version 5.4.3 crashes on Android" [#1159](https://github.com/javadtaghia/flutter_adeeinappwebview/issues/1159)

## 5.4.3+1

- Try to fix "Latest version 5.4.3 crashes on Android" [#1159](https://github.com/javadtaghia/flutter_adeeinappwebview/issues/1159)
...
- Try to fix "Latest version 5.4.2 crashes on Android - HeadlessInAppWebView.dispose" [#1155](https://github.com/javadtaghia/flutter_adeeinappwebview/issues/1155)
...
- Fixed "Android ServiceWorkerControllerCompat.setServiceWorkerClient(null) makes Webivew Plugin Crashes" [#1151](https://github.com/javadtaghia/flutter_adeeinappwebview/issues/1151)
...
- Merged "[Android] Explicitly export for the receiver defined in AndroidManifest" [#1147](https://github.com/javadtaghia/flutter_adeeinappwebview/pull/1147) (thanks to [AlexV525](https://github.com/AlexV525))
...
- Fixed "applicationNameForUserAgent is not work in ios" [#525](https://github.com/javadtaghia/flutter_adeeinappwebview/issues/525)
- Fixed "Crash when try select file from webview input on Android" [#867](https://github.com/javadtaghia/flutter_adeeinappwebview/issues/867)
- Fixed "NavigationAction.request should use toMap method" [#878](https://github.com/javadtaghia/flutter_adeeinappwebview/issues/878)
- Fixed "Missing body field in URLRequest toMap method" [#990](https://github.com/javadtaghia/flutter_adeeinappwebview/issues/990)
- Fixed "iOS : createWindowAction.request.body in onCreateWindow() is NULL" [#994](https://github.com/javadtaghia/flutter_adeeinappwebview/issues/994)
...
- Fixed "In App Browser Crashing in Android - Action Bar is null" [#1137](https://github.com/javadtaghia/flutter_adeeinappwebview/issues/1137)
- Fixed "Cannot load Javascript on some Android devices - Uncaught TypeError: Cannot read property 'appendChild' of null" [#888](https://github.com/javadtaghia/flutter_adeeinappwebview/issues/888)
- Merged "Update Options.swift" [#889](https://github.com/javadtaghia/flutter_adeeinappwebview/pull/889) (thanks to [cloudygeek](https://github.com/cloudygeek))
- Merged "fix: Applicatio nNameForUserAgent is not working in iOS" [#1095](https://github.com/javadtaghia/flutter_adeeinappwebview/pull/1095) (thanks to [sunalwaysknows](https://github.com/sunalwaysknows))
- Merged "Make sure we open a new instance of a custom chrome chrome tab" [#812](https://github.com/javadtaghia/flutter_adeeinappwebview/pull/812) (thanks to [savy-91](https://github.com/savy-91))
- Merged "fix bug when in String[] array come null" [#868](https://github.com/javadtaghia/flutter_adeeinappwebview/pull/868) (thanks to [Ser1ous](https://github.com/Ser1ous))
- Merged "fix: use in NavigationAction request toMap method" [#879](https://github.com/javadtaghia/flutter_adeeinappwebview/pull/879) (thanks to [chreck](https://github.com/chreck))
- Merged "switch android mockserver dependency with okhttp" [#946](https://github.com/javadtaghia/flutter_adeeinappwebview/pull/946) (thanks to [randysecrist](https://github.com/randysecrist))
- Merged "Adds missing body to URLRequest mapping." [#991](https://github.com/javadtaghia/flutter_adeeinappwebview/pull/991) (thanks to [Miiha](https://github.com/Miiha))
- Merged "fix. Crash happens when HeadlessInAppWebView's dispose function is called in iOS" [#1017](https://github.com/javadtaghia/flutter_adeeinappwebview/pull/1017) (thanks to [hoanglm4](https://github.com/hoanglm4))
- Merged "Fixes URL returned when taping image with href in onCreateWindow [Android]" [#1042](https://github.com/javadtaghia/flutter_adeeinappwebview/pull/1042) (thanks to [Manuito83](https://github.com/Manuito83))
- Merged "Fix Android Sometimes crash after close webpage and return to platform code." [#1050](https://github.com/javadtaghia/flutter_adeeinappwebview/pull/1050) (thanks to [rsydor](https://github.com/rsydor))
- Merged "Add application/wasm MimeType with InAppLocalhostServer" [#1054](https://github.com/javadtaghia/flutter_adeeinappwebview/pull/1054) (thanks to [foxstream528](https://github.com/foxstream528))
- Merged "Fixed the unexpected behavior of InAppWebView and HeadlessInAppWebView when initialUrlRequest was set as null." [#1064](https://github.com/javadtaghia/flutter_adeeinappwebview/pull/1064) (thanks to [RodXander](https://github.com/RodXander))
- Merged "updated com.android.tools.build:gradle" [#1066](https://github.com/javadtaghia/flutter_adeeinappwebview/pull/1066) (thanks to [chownation](https://github.com/chownation))
- Merged "WIP - expose content-disposition and content-length from android" [#1088](https://github.com/javadtaghia/flutter_adeeinappwebview/pull/1088) (thanks to [ashank96](https://github.com/ashank96))
- Merged "Fix ios persistance when using sharedCookie" [#1093](https://github.com/javadtaghia/flutter_adeeinappwebview/pull/1093) (thanks to [EA-YOUHOU](https://github.com/EA-YOUHOU))
- Merged "Fixes zoomBy with floats (iOS)" [#1109](https://github.com/javadtaghia/flutter_adeeinappwebview/pull/1109) (thanks to [Manuito83](https://github.com/Manuito83))
- Merged "Build on and support Android 12 SDK 31" [#1111](https://github.com/javadtaghia/flutter_adeeinappwebview/pull/1111) (thanks to [carloserazo47](https://github.com/carloserazo47))
- Merged "Fix takeScreenshot Crash on iOS" [#1123](https://github.com/javadtaghia/flutter_adeeinappwebview/pull/1123) (thanks to [a00012025](https://github.com/a00012025))
- Merged "Feature. Possibility to disable iOS above keyboard inputAccessoryView" [#1124](https://github.com/javadtaghia/flutter_adeeinappwebview/pull/1124) (thanks to [cutzmf](https://github.com/cutzmf))
...
- Fixed "iOS webview showing blank page in specific URL" [#776](https://github.com/javadtaghia/flutter_adeeinappwebview/issues/776)
- Fixed "unable to access ApplicationDocumentsDirectory in real Ios devices" [#748](https://github.com/javadtaghia/flutter_adeeinappwebview/issues/748)

## 5.3.0+1

- Fixed "Android - Pull to refresh triggered when scrolling container inside a website" [#765](https://github.com/javadtaghia/flutter_adeeinappwebview/issues/765)
...
- Fixed iOS "Unexpectedly found nil while unwrapping an Optional value: file flutter_adeeinappwebview/WKUserContentController.swift, line 36" error when `applePayAPIEnabled` iOS-specific WebView option is enabled
...
- Fixed "java.lang.NullPointerException: Attempt to invoke virtual method 'void android.widget.SearchView.setQuery(java.lang.CharSequence, boolean)' on a null object reference" [#742](https://github.com/javadtaghia/flutter_adeeinappwebview/issues/742)
- Fixed Android js error in some very rare case where `window.flutter_adeeinappwebview` is `undefined` when loading plugin scripts
...
- Attempt to fix "InAppBrowserActivity.onCreate NullPointerException - Attempt to invoke virtual method 'java.lang.String android.os.Bundle.getString(java.lang.String)' on a null object reference" [#665](https://github.com/javadtaghia/flutter_adeeinappwebview/issues/665)
- Fixed "[iOS] Application crashes when processing onCreateWindow" [#579](https://github.com/javadtaghia/flutter_adeeinappwebview/issues/579)
- Fixed wrong mapping of `NavigationAction` class on Android for `androidHasGesture` and `androidIsRedirect` properties
- Fixed "Pull to refresh creating problem in some webpages on Android" [#719](https://github.com/javadtaghia/flutter_adeeinappwebview/issues/719)
...
- Fixed "InAppLocalhostServer - Error: type 'List<dynamic>' is not a subtype of type 'List<int>' in type cast" [#724](https://github.com/javadtaghia/flutter_adeeinappwebview/issues/724)
- Merged "fix proguard" [#737](https://github.com/javadtaghia/flutter_adeeinappwebview/pull/737) (thanks to [myroid](https://github.com/myroid))
...
- Fixed "IOS scrolling crash the application" [#707](https://github.com/javadtaghia/flutter_adeeinappwebview/issues/707)

## 5.1.0+3

- Fixed "Unsupported operation: Platform._operatingSystem" when compiling for Web again [#507](https://github.com/javadtaghia/flutter_adeeinappwebview/issues/507)
...
- Added support for pull-to-refresh feature [#395](https://github.com/javadtaghia/flutter_adeeinappwebview/issues/395)
- Fixed issue not rendering WebView content when scrolling on iOS [#703](https://github.com/javadtaghia/flutter_adeeinappwebview/issues/703)
...
- Fixed "No bounce in inappwebview iOS" [#696](https://github.com/javadtaghia/flutter_adeeinappwebview/issues/696)
...
- Added Android Hybrid Composition support "Use PlatformViewLink widget for Android WebView" [#462](https://github.com/javadtaghia/flutter_adeeinappwebview/pull/462) (thanks to [plateaukao](https://github.com/plateaukao) and [tneotia](https://github.com/tneotia))
...
- Merged "Upgraded appcompat to 1.2.0-rc-02" [#465](https://github.com/javadtaghia/flutter_adeeinappwebview/pull/465) (thanks to [andreidiaconu](https://github.com/andreidiaconu))
- Merged "Added missing field 'headers' which returned by WebResourceResponse.toMap()" [#490](https://github.com/javadtaghia/flutter_adeeinappwebview/pull/490) (thanks to [Doflatango](https://github.com/Doflatango))
- Merged "Fix: added iOS fallback module import" [#466](https://github.com/javadtaghia/flutter_adeeinappwebview/pull/466) (thanks to [Eddayy](https://github.com/Eddayy))
- Merged "Fix NullPointerException after taking a photo by a camera app on Android" [#492](https://github.com/javadtaghia/flutter_adeeinappwebview/pull/492) (thanks to [AAkira](https://github.com/AAkira))
- Merged "iOS CookieManager.getCookies - Check that URL has suffix of cookie do…" [#658](https://github.com/javadtaghia/flutter_adeeinappwebview/pull/658) (thanks to [arneke](https://github.com/arneke))
- Merged "Add NTLM Auth" [#634](https://github.com/javadtaghia/flutter_adeeinappwebview/pull/634) (thanks to [albatrosify](https://github.com/albatrosify))
- Merged "iOS ChromeSafariBrowserManager - Fixing unnecessary casting of rootViewController to FlutterViewController" [#567](https://github.com/javadtaghia/flutter_adeeinappwebview/pull/567) (thanks to [gunantosteven](https://github.com/gunantosteven))
- Merged "Fix _channel.invokeMethod name for injectCSSFileFromUrl method" [#645](https://github.com/javadtaghia/flutter_adeeinappwebview/pull/645) (thanks to [omralcrt](https://github.com/omralcrt))
- Merged "Add android media intents on wildcard input accept" [#620](https://github.com/javadtaghia/flutter_adeeinappwebview/pull/620) (thanks to [cbodin](https://github.com/cbodin))
- Merged "Add ChromeSafariBrowser support for Android 11" [#538](https://github.com/javadtaghia/flutter_adeeinappwebview/pull/538) (thanks to [DRSchlaubi](https://github.com/DRSchlaubi))
- Merged "fix(iOS): missing implementation of method zoomBy" [#670](https://github.com/javadtaghia/flutter_adeeinappwebview/pull/670) (thanks to [pcqpcq](https://github.com/pcqpcq))
- Merged "[mod] Fix all issues relate to long click in Android version 7.0 (#657, #527)" [#671](https://github.com/javadtaghia/flutter_adeeinappwebview/pull/671) (thanks to [MrNinja](https://github.com/MrNinja))
- Merged "Fix ViewGroup.removeView NullPointerException (#450)" [#683](https://github.com/javadtaghia/flutter_adeeinappwebview/pull/683) (thanks to [toda-bps](https://github.com/toda-bps))
- Fixed missing properties initialization when using InAppWebViewController.fromInAppBrowser
- Fixed "Issue in Flutter web: 'Unsupported operation: Platform._operatingSystem'" [#507](https://github.com/javadtaghia/flutter_adeeinappwebview/issues/507)
- Fixed "window.flutter_adeeinappwebview.callHandler is not a function" [#218](https://github.com/javadtaghia/flutter_adeeinappwebview/issues/218)
- Fixed "Android ContentBlocker - java.lang.NullPointerException ContentBlockerTrigger resource type" [#506](https://github.com/javadtaghia/flutter_adeeinappwebview/issues/506)
- Fixed "Android CookieManager throws error caused by websites that are sending back illegal/invalid cookies." [#476](https://github.com/javadtaghia/flutter_adeeinappwebview/issues/476)
...
- Fixed "IOS does not support allowUniversalAccessFromFileURLs" [#654](https://github.com/javadtaghia/flutter_adeeinappwebview/issues/654)
- Fixed "Failed to load WebView provider: No WebView installed" [#642](https://github.com/javadtaghia/flutter_adeeinappwebview/issues/642)
- Fixed "java.net.MalformedURLException: unknown protocol: wss - Error using library sipml5 in flutter_adeeinappwebview" [#614](https://github.com/javadtaghia/flutter_adeeinappwebview/issues/614)
- Fixed "Android 10 clipboard not working properly" [#678](https://github.com/javadtaghia/flutter_adeeinappwebview/issues/678) (thanks to [armadastate](https://github.com/armadastate))
...
- Fixed "Build for web not working – The integer literal 9223372036854775807 can't be represented exactly in JavaScript" [#429](https://github.com/javadtaghia/flutter_adeeinappwebview/issues/429)
...
- Fixed "SFSafariViewController doesn't open like a native iOS modal" [#403](https://github.com/javadtaghia/flutter_adeeinappwebview/issues/403)
...
- Fixed `After upgrade to Android embedding V2, still get Shared.activity is null / NullPointerException on android.content.Context.getResources()` [#390](https://github.com/javadtaghia/flutter_adeeinappwebview/issues/390)
...
- Fixed `Multiple sessions` [#371](https://github.com/javadtaghia/flutter_adeeinappwebview/issues/371)
- Fixed `incognito mode is broken swift` [#320](https://github.com/javadtaghia/flutter_adeeinappwebview/issues/320)
...
- Added `onEnterFullscreen`, `onExitFullscreen` webview events [#275](https://github.com/javadtaghia/flutter_adeeinappwebview/issues/275)
- Added Android support to use camera on HTML inputs that requires it, such as `<input type="file" accept="image/*" capture>` [#353](https://github.com/javadtaghia/flutter_adeeinappwebview/issues/353)
...
- Fixed `Print preview is not working? java.lang.IllegalStateException: Can print only from an activity` [#128](https://github.com/javadtaghia/flutter_adeeinappwebview/issues/128)
- Fixed `onJsAlert`, `onJsConfirm`, `onJsPrompt` for `InAppBrowser` on Android
- Fixed `onActivityResult` for `InAppBrowser` on Android
- Fixed `InAppBrowser.openWithSystemBrowser crash on iOS` [#358](https://github.com/javadtaghia/flutter_adeeinappwebview/issues/358)
- Fixed `Attempt to invoke virtual method 'java.util.Set java.util.HashMap.entrySet()' on a null object reference` [#367](https://github.com/javadtaghia/flutter_adeeinappwebview/issues/367)
...
- Added `ContextMenu` and `ContextMenuItem` classes [#235](https://github.com/javadtaghia/flutter_adeeinappwebview/issues/235)
...
- Fixed `Confirmation dialog (onbeforeunload) displayed after popped from webview page` [#337](https://github.com/javadtaghia/flutter_adeeinappwebview/issues/337)
- Fixed `CookieManager.setCookie` `expiresDate` option
- Fixed `Scrolling not smooth on iOS` [#341](https://github.com/javadtaghia/flutter_adeeinappwebview/issues/341)
...
- Fixed iOS presentationStyle affecting only dismiss animation [#305](https://github.com/javadtaghia/flutter_adeeinappwebview/issues/305)
...
- Added `Promise` javascript [polyfill](https://github.com/tildeio/rsvp.js) for webviews that doesn't support it for `window.flutter_adeeinappwebview.callHandler`
...
- Added `packageName` [#229](https://github.com/javadtaghia/flutter_adeeinappwebview/issues/229) and `keepAliveEnabled` ChromeCustomTab options for Android
...
- Merged "Fixes null error when calling getOptions for InAppBrowser class" [#214](https://github.com/javadtaghia/flutter_adeeinappwebview/pull/214) (thanks to [panndoraBoo](https://github.com/panndoraBoo))
- Merged "Fixes crash onConsoleMessage iOS forced unwrapping" [#228](https://github.com/javadtaghia/flutter_adeeinappwebview/pull/228) (thanks to [tokonu](https://github.com/tokonu))
- Merged "Fix HTTPCookie.secure" [#311](https://github.com/javadtaghia/flutter_adeeinappwebview/pull/311) (thanks to [xtyxtyx](https://github.com/xtyxtyx))
- Merged "Fix config options for Android release builds" [#295](https://github.com/javadtaghia/flutter_adeeinappwebview/pull/295) (thanks to [wwwdata](https://github.com/wwwdata))
- Merged "fix scrollbar on iOS always show if not disable scroll" [#256](https://github.com/javadtaghia/flutter_adeeinappwebview/pull/256) (thanks to [phamnhuvu-dev](https://github.com/phamnhuvu-dev))
- Merged "Fix crash on nil/invalid URL (iOS)" [#262](https://github.com/javadtaghia/flutter_adeeinappwebview/pull/262) (thanks to [AlexVincent525](https://github.com/AlexVincent525))
- Merged "Fix crash when `prompt` was called on Android Q." [#262](https://github.com/javadtaghia/flutter_adeeinappwebview/pull/263) (thanks to [AlexVincent525](https://github.com/AlexVincent525))
- Fix for Android and iOS `InAppBrowser` for some controller methods not exposed.
- Fixed "App Crashes after clicking on dropdown (Using inappwebview)" [#182](https://github.com/javadtaghia/flutter_adeeinappwebview/issues/182)
- Fixed "webview can not be released when in ios" [#225](https://github.com/javadtaghia/flutter_adeeinappwebview/issues/225). Now the iOS WebView is released from memory when it is disposed from Flutter.
- Fixed "Setting of presentationStyle not working on iOS" [#213](https://github.com/javadtaghia/flutter_adeeinappwebview/issues/213)
- Fixed "Android zoom issues" [#270](https://github.com/javadtaghia/flutter_adeeinappwebview/issues/270)
...
- Fix "problems with onReceivedHttpAuthRequest when initialData is used" [#201](https://github.com/javadtaghia/flutter_adeeinappwebview/issues/201)
- Fix "System ui (status bar and navigation bar) doesn't hide automatically" [#202](https://github.com/javadtaghia/flutter_adeeinappwebview/issues/202)
...
- Merged "Avoid null pointer exception after webview is disposed" [#116](https://github.com/javadtaghia/flutter_adeeinappwebview/pull/116) (thanks to [robsonfingo](https://github.com/robsonfingo))
- Merged "Remove async call in close" [#119](https://github.com/javadtaghia/flutter_adeeinappwebview/pull/119) (thanks to [benfingo](https://github.com/benfingo))
- Merged "Android takeScreenshot does not work properly." [#122](https://github.com/javadtaghia/flutter_adeeinappwebview/pull/122) (thanks to [PauloMelo](https://github.com/PauloMelo))
- Merged "Resolving gradle error." [#144](https://github.com/javadtaghia/flutter_adeeinappwebview/pull/144) (thanks to [Klingens13](https://github.com/Klingens13))
- Merged "Create issue and pull request templates" [#150](https://github.com/javadtaghia/flutter_adeeinappwebview/pull/150) (thanks to [deandreamatias](https://github.com/deandreamatias))
- Merged "Fix abstract method error && swift version error" [#155](https://github.com/javadtaghia/flutter_adeeinappwebview/pull/155) (thanks to [AlexVincent525](https://github.com/AlexVincent525))
- Merged "migrating to swift 5.0" [#162](https://github.com/javadtaghia/flutter_adeeinappwebview/pull/162) (thanks to [fattiger00](https://github.com/fattiger00))
- Merged "Update readme example" [#178](https://github.com/javadtaghia/flutter_adeeinappwebview/pull/178) (thanks to [SebastienBtr](https://github.com/SebastienBtr))
- Merged "handle choose file callback in android" [#183](https://github.com/javadtaghia/flutter_adeeinappwebview/pull/183) (thanks to [crazecoder](https://github.com/crazecoder))
- Merged "add initialScale in android" [#186](https://github.com/javadtaghia/flutter_adeeinappwebview/pull/186) (thanks to [crazecoder](https://github.com/crazecoder))
- Added `horizontalScrollBarEnabled` and `verticalScrollBarEnabled` options to enable/disable the corresponding scrollbar of the WebView [#165](https://github.com/javadtaghia/flutter_adeeinappwebview/issues/165)
...
- Merged "added a shared WKProcessPool for webview instances" [#198](https://github.com/javadtaghia/flutter_adeeinappwebview/pull/198) (thanks to [robertcnst](https://github.com/robertcnst))
- Fixed iOS setCookie.

## 1.2.1

- Merged "Add new option to control the contentMode in Android platform" [#101](https://github.com/javadtaghia/flutter_adeeinappwebview/pull/101) (thanks to [DreamBuddy](https://github.com/DreamBuddy))
- Merged "Fix crash on xcode 10.2" [#107](https://github.com/javadtaghia/flutter_adeeinappwebview/pull/107) (thanks to [robsonfingo](https://github.com/robsonfingo))
- Merged "Remove headers_build_phase from example's Podfile" [#108](https://github.com/javadtaghia/flutter_adeeinappwebview/pull/108) (thanks to [robsonfingo](https://github.com/robsonfingo))
- Fixed "Make html5 video fullscreen" for Android [#43](https://github.com/javadtaghia/flutter_adeeinappwebview/issues/43)
- Fixed "AllowsInlineMediaPlayback not working" for iOS [#73](https://github.com/javadtaghia/flutter_adeeinappwebview/issues/73)

## 1.2.0

- Merged "Adds a transparentBackground option for iOS and Android" [#86](https://github.com/javadtaghia/flutter_adeeinappwebview/pull/86) (thanks to [matthewlloyd](https://github.com/matthewlloyd))
- Merged "The 'open' method requires an options dictionary" [#87](https://github.com/javadtaghia/flutter_adeeinappwebview/pull/87) (thanks to [matthewlloyd](https://github.com/matthewlloyd))
- Merged "iOS: Call setNeedsLayout() in scrollViewDidScroll()" [#88](https://github.com/javadtaghia/flutter_adeeinappwebview/pull/88) (thanks to [matthewlloyd](https://github.com/matthewlloyd))
- Fixed "java.lang.RuntimeException: Methods marked with @UiThread must be executed on the main thread." [#98](https://github.com/javadtaghia/flutter_adeeinappwebview/issues/98) (thanks to [DreamBuddy](https://github.com/DreamBuddy))
- Fixed "app force close/crash when enabling zoom and repeatedly changing orientation and zoomin zoomout" [#93](https://github.com/javadtaghia/flutter_adeeinappwebview/issues/93)
- Added `displayZoomControls` webview option for Android
- Fixed "Compatibility with other plugins" [#80](https://github.com/javadtaghia/flutter_adeeinappwebview/issues/80)

## 1.1.3

- Merged "Add null checks around calls to InAppWebView callbacks" [#85](https://github.com/javadtaghia/flutter_adeeinappwebview/pull/85) (thanks to [matthewlloyd](https://github.com/matthewlloyd))

## 1.1.2

- Fix InAppBrowser crashes the app when i change the page "Lost connection" [#74](https://github.com/javadtaghia/flutter_adeeinappwebview/issues/74)
- Fix javascript `...args` parameter of `window.flutter_adeeinappwebview.callHandler()`
- Merged Enable setTextZoom function of Android WebViewSetting [#81](https://github.com/javadtaghia/flutter_adeeinappwebview/pull/81) (thanks to [YouCii](https://github.com/YouCii))
- Merged bug fix for android build: Android dependency 'androidx.core:core' has different version for the compile (1.0.0) and runtime (1.0.1) classpath [#83](https://github.com/javadtaghia/flutter_adeeinappwebview/pull/83) (thanks to [cinos1](https://github.com/cinos1))
...
- `addJavaScriptHandler` method can return data to JavaScript using `Promise` [#46](https://github.com/javadtaghia/flutter_adeeinappwebview/issues/46)
- added `flutterInAppBrowserPlatformReady` JavaScript event to wait until the platform is ready [#64](https://github.com/javadtaghia/flutter_adeeinappwebview/issues/64)
