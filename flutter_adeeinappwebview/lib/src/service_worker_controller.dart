...
///{@macro flutter_adeeinappwebview_platform_interface.PlatformServiceWorkerController}
class ServiceWorkerController {
  ...
  ///{@macro flutter_adeeinappwebview_platform_interface.PlatformServiceWorkerController.serviceWorkerClient}
  ServiceWorkerClient? get serviceWorkerClient => platform.serviceWorkerClient;

  ///{@macro flutter_adeeinappwebview_platform_interface.PlatformServiceWorkerController.setServiceWorkerClient}
  setServiceWorkerClient(ServiceWorkerClient? value) =>
      platform.setServiceWorkerClient(value);

  ///{@macro flutter_adeeinappwebview_platform_interface.PlatformServiceWorkerController.getAllowContentAccess}
  static Future<bool> getAllowContentAccess() =>
      PlatformServiceWorkerController.static().getAllowContentAccess();

  ///{@macro flutter_adeeinappwebview_platform_interface.PlatformServiceWorkerController.getAllowFileAccess}
  static Future<bool> getAllowFileAccess() =>
      PlatformServiceWorkerController.static().getAllowFileAccess();

  ///{@macro flutter_adeeinappwebview_platform_interface.PlatformServiceWorkerController.getBlockNetworkLoads}
  static Future<bool> getBlockNetworkLoads() =>
      PlatformServiceWorkerController.static().getBlockNetworkLoads();

  ///{@macro flutter_adeeinappwebview_platform_interface.PlatformServiceWorkerController.getCacheMode}
  static Future<CacheMode?> getCacheMode() =>
      PlatformServiceWorkerController.static().getCacheMode();

  ///{@macro flutter_adeeinappwebview_platform_interface.PlatformServiceWorkerController.setAllowContentAccess}
  static Future<void> setAllowContentAccess(bool allow) =>
      PlatformServiceWorkerController.static().setAllowContentAccess(allow);

  ///{@macro flutter_adeeinappwebview_platform_interface.PlatformServiceWorkerController.setAllowFileAccess}
  static Future<void> setAllowFileAccess(bool allow) =>
      PlatformServiceWorkerController.static().setAllowFileAccess(allow);

  ///{@macro flutter_adeeinappwebview_platform_interface.PlatformServiceWorkerController.setBlockNetworkLoads}
  static Future<void> setBlockNetworkLoads(bool flag) =>
      PlatformServiceWorkerController.static().setBlockNetworkLoads(flag);

  ///{@macro flutter_adeeinappwebview_platform_interface.PlatformServiceWorkerController.setCacheMode}
