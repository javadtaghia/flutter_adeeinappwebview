...
///{@macro flutter_adeeinappwebview_platform_interface.PlatformInAppLocalhostServer}
class InAppLocalhostServer {
  ...
  ///{@macro flutter_adeeinappwebview_platform_interface.PlatformInAppLocalhostServer.start}
  Future<void> start() => platform.start();

  ///{@macro flutter_adeeinappwebview_platform_interface.PlatformInAppLocalhostServer.close}
  Future<void> close() => platform.close();

  ///{@macro flutter_adeeinappwebview_platform_interface.PlatformInAppLocalhostServer.isRunning}
