...
///{@macro flutter_adeeinappwebview_platform_interface.PlatformPrintJobController}
class PrintJobController {
  ...
  ///{@macro flutter_adeeinappwebview_platform_interface.PlatformPrintJobController.cancel}
  Future<void> cancel() => platform.cancel();

  ///{@macro flutter_adeeinappwebview_platform_interface.PlatformPrintJobController.restart}
  Future<void> restart() => platform.restart();

  ///{@macro flutter_adeeinappwebview_platform_interface.PlatformPrintJobController.dismiss}
  Future<void> dismiss({bool animated = true}) =>
      platform.dismiss(animated: animated);

  ///{@macro flutter_adeeinappwebview_platform_interface.PlatformPrintJobController.getInfo}
  Future<PrintJobInfo?> getInfo() => platform.getInfo();

  ///{@macro flutter_adeeinappwebview_platform_interface.PlatformPrintJobController.dispose}
