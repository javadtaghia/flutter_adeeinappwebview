...
///{@macro flutter_adeeinappwebview_platform_interface.PlatformChromeSafariBrowser}
class ChromeSafariBrowser implements PlatformChromeSafariBrowserEvents {
  ...
  ///{@macro flutter_adeeinappwebview_platform_interface.PlatformChromeSafariBrowser.id}
  String get id => platform.id;

  ///{@macro flutter_adeeinappwebview_platform_interface.PlatformChromeSafariBrowser.open}
  Future<void> open(
          {WebUri? url,
  ...
  ///{@macro flutter_adeeinappwebview_platform_interface.PlatformChromeSafariBrowser.launchUrl}
  ...
  ///{@macro flutter_adeeinappwebview_platform_interface.PlatformChromeSafariBrowser.mayLaunchUrl}
  ...
  ///{@macro flutter_adeeinappwebview_platform_interface.PlatformChromeSafariBrowser.validateRelationship}
  ...
  ///{@macro flutter_adeeinappwebview_platform_interface.PlatformChromeSafariBrowser.close}
  Future<void> close() => platform.close();

  ///{@macro flutter_adeeinappwebview_platform_interface.PlatformChromeSafariBrowser.isOpened}
  bool isOpened() => platform.isOpened();

  ///{@macro flutter_adeeinappwebview_platform_interface.PlatformChromeSafariBrowser.setActionButton}
  void setActionButton(ChromeSafariBrowserActionButton actionButton) =>
      platform.setActionButton(actionButton);

  ///{@macro flutter_adeeinappwebview_platform_interface.PlatformChromeSafariBrowser.updateActionButton}
  ...
  ///{@macro flutter_adeeinappwebview_platform_interface.PlatformChromeSafariBrowser.setSecondaryToolbar}
  ...
  ///{@macro flutter_adeeinappwebview_platform_interface.PlatformChromeSafariBrowser.updateSecondaryToolbar}
  Future<void> updateSecondaryToolbar(
          ChromeSafariBrowserSecondaryToolbar secondaryToolbar) =>
      platform.updateSecondaryToolbar(secondaryToolbar);

  ///{@macro flutter_adeeinappwebview_platform_interface.PlatformChromeSafariBrowser.addMenuItem}
  void addMenuItem(ChromeSafariBrowserMenuItem menuItem) =>
      platform.addMenuItem(menuItem);

  ///{@macro flutter_adeeinappwebview_platform_interface.PlatformChromeSafariBrowser.addMenuItems}
  void addMenuItems(List<ChromeSafariBrowserMenuItem> menuItems) =>
      platform.addMenuItems(menuItems);

  ///{@macro flutter_adeeinappwebview_platform_interface.PlatformChromeSafariBrowser.requestPostMessageChannel}
  ...
  ///{@macro flutter_adeeinappwebview_platform_interface.PlatformChromeSafariBrowser.postMessage}
  Future<CustomTabsPostMessageResultType> postMessage(String message) =>
      platform.postMessage(message);

  ///{@macro flutter_adeeinappwebview_platform_interface.PlatformChromeSafariBrowser.isEngagementSignalsApiAvailable}
  Future<bool> isEngagementSignalsApiAvailable() =>
      platform.isEngagementSignalsApiAvailable();

  ///{@macro flutter_adeeinappwebview_platform_interface.PlatformChromeSafariBrowser.isAvailable}
  static Future<bool> isAvailable() =>
      PlatformChromeSafariBrowser.static().isAvailable();

  ///{@macro flutter_adeeinappwebview_platform_interface.PlatformChromeSafariBrowser.getMaxToolbarItems}
  static Future<int> getMaxToolbarItems() =>
      PlatformChromeSafariBrowser.static().getMaxToolbarItems();

  ///{@macro flutter_adeeinappwebview_platform_interface.PlatformChromeSafariBrowser.getPackageName}
  ...
  ///{@macro flutter_adeeinappwebview_platform_interface.PlatformChromeSafariBrowser.clearWebsiteData}
  static Future<void> clearWebsiteData() =>
      PlatformChromeSafariBrowser.static().clearWebsiteData();

  ///{@macro flutter_adeeinappwebview_platform_interface.PlatformChromeSafariBrowser.prewarmConnections}
  ...
  ///{@macro flutter_adeeinappwebview_platform_interface.PlatformChromeSafariBrowser.invalidatePrewarmingToken}
  static Future<void> invalidatePrewarmingToken(
          PrewarmingToken prewarmingToken) =>
      PlatformChromeSafariBrowser.static()
          .invalidatePrewarmingToken(prewarmingToken);

  ///{@macro flutter_adeeinappwebview_platform_interface.PlatformChromeSafariBrowser.dispose}
  @mustCallSuper
