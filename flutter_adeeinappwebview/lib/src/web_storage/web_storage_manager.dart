...
///{@macro flutter_adeeinappwebview_platform_interface.PlatformWebStorageManager}
class WebStorageManager {
  ...
  ///{@macro flutter_adeeinappwebview_platform_interface.PlatformWebStorageManager.getOrigins}
  Future<List<WebStorageOrigin>> getOrigins() => platform.getOrigins();

  ///{@macro flutter_adeeinappwebview_platform_interface.PlatformWebStorageManager.deleteAllData}
  Future<void> deleteAllData() => platform.deleteAllData();

  ///{@macro flutter_adeeinappwebview_platform_interface.PlatformWebStorageManager.deleteOrigin}
  Future<void> deleteOrigin({required String origin}) =>
      platform.deleteOrigin(origin: origin);

  ///{@macro flutter_adeeinappwebview_platform_interface.PlatformWebStorageManager.getQuotaForOrigin}
  Future<int> getQuotaForOrigin({required String origin}) =>
      platform.getQuotaForOrigin(origin: origin);

  ///{@macro flutter_adeeinappwebview_platform_interface.PlatformWebStorageManager.getUsageForOrigin}
  Future<int> getUsageForOrigin({required String origin}) =>
      platform.getUsageForOrigin(origin: origin);

  ///{@macro flutter_adeeinappwebview_platform_interface.PlatformWebStorageManager.fetchDataRecords}
  Future<List<WebsiteDataRecord>> fetchDataRecords(
          {required Set<WebsiteDataType> dataTypes}) =>
      platform.fetchDataRecords(dataTypes: dataTypes);

  ///{@macro flutter_adeeinappwebview_platform_interface.PlatformWebStorageManager.removeDataFor}
  ...
  ///{@macro flutter_adeeinappwebview_platform_interface.PlatformWebStorageManager.removeDataModifiedSince}
