...
///{@macro flutter_adeeinappwebview_platform_interface.PlatformTracingController}
class TracingController {
  ...
  ///{@macro flutter_adeeinappwebview_platform_interface.PlatformTracingController.start}
  Future<void> start({required TracingSettings settings}) =>
      platform.start(settings: settings);

  ///{@macro flutter_adeeinappwebview_platform_interface.PlatformTracingController.stop}
  Future<bool> stop({String? filePath}) => platform.stop(filePath: filePath);

  ///{@macro flutter_adeeinappwebview_platform_interface.PlatformTracingController.isTracing}
