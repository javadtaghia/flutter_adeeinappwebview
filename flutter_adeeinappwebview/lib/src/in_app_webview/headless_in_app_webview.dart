...
///{@macro flutter_adeeinappwebview_platform_interface.PlatformHeadlessInAppWebView}
class HeadlessInAppWebView {
  ...
  ///{@macro flutter_adeeinappwebview_platform_interface.PlatformHeadlessInAppWebView.id}
  String get id => platform.id;

  ///{@macro flutter_adeeinappwebview_platform_interface.PlatformHeadlessInAppWebView.webViewController}
  ...
  ///{@macro flutter_adeeinappwebview_platform_interface.PlatformHeadlessInAppWebView.run}
  Future<void> run() => platform.run();

  ///{@macro flutter_adeeinappwebview_platform_interface.PlatformHeadlessInAppWebView.isRunning}
  bool isRunning() => platform.isRunning();

  ///{@macro flutter_adeeinappwebview_platform_interface.PlatformHeadlessInAppWebView.setSize}
  Future<void> setSize(Size size) => platform.setSize(size);

  ///{@macro flutter_adeeinappwebview_platform_interface.PlatformHeadlessInAppWebView.getSize}
  Future<Size?> getSize() => platform.getSize();

  ///{@macro flutter_adeeinappwebview_platform_interface.PlatformHeadlessInAppWebView.dispose}
