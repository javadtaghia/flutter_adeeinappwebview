...
///{@macro flutter_adeeinappwebview_platform_interface.PlatformProxyController}
class ProxyController {
  ...
  ///{@macro flutter_adeeinappwebview_platform_interface.PlatformProxyController.setProxyOverride}
  Future<void> setProxyOverride({required ProxySettings settings}) =>
      platform.setProxyOverride(settings: settings);

  ///{@macro flutter_adeeinappwebview_platform_interface.PlatformProxyController.clearProxyOverride}
