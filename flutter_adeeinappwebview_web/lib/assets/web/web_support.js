window.flutter_adeeinappwebview = {
    webViews: {},
            ...
            prepare: function(settings) {
                ...
                document.addEventListener('fullscreenchange', function(event) {
                    ...
                    if (document.fullscreenElement && document.fullscreenElement.id == iframeId) {
                        ...
                        window.flutter_adeeinappwebview.nativeCommunication('onEnterFullscreen', viewId);
                    } else if (!document.fullscreenElement && webView.isFullscreen) {
                        webView.isFullscreen = false;
                        window.flutter_adeeinappwebview.nativeCommunication('onExitFullscreen', viewId);
                    } else {
                        webView.isFullscreen = false;
                    }
                });
                ...
                if (iframe != null) {
                    ...
                    iframe.addEventListener('load', function (event) {
                        ...
                        window.flutter_adeeinappwebview.nativeCommunication('onLoadStart', viewId, [url]);
                            ...
                            for (var k in oldLogs) {
                                (function(oldLog) {
                                    iframe.contentWindow.console[oldLog] = function() {
                                        ...
                                        window.flutter_adeeinappwebview.nativeCommunication('onConsoleMessage', viewId, [oldLog, message]);
                                    }
                                })(k);
                            }
                        } catch (e) {
                        ...
                        try {
                            ...
                            iframe.contentWindow.history.pushState = function (state, unused, url) {
                                ...
                                window.flutter_adeeinappwebview.nativeCommunication('onUpdateVisitedHistory', viewId, [iframeUrl]);
                            };
                            ...
                            iframe.contentWindow.open = function (url, target, windowFeatures) {
                                ...
                                window.flutter_adeeinappwebview.nativeCommunication('onCreateWindow', viewId, [windowId, url, target, windowFeatures]).then(function(){}, function(handledByClient) {
                                    if (handledByClient) {
                                        newWindow.close();
                                    }
                                });
                            ...
                            iframe.contentWindow.print = function() {
                                ...
                                window.flutter_adeeinappwebview.nativeCommunication('onPrintRequest', viewId, [iframeUrl]);
                            ...
                            window.flutter_adeeinappwebview.nativeCommunication('onTitleChanged', viewId, [initialTitle]);
                            if (titleEl != null) {
                                new MutationObserver(function(mutations) {
                                    var title = mutations[0].target.innerText;
                                    if (title != webView.documentTitle) {
                                        webView.documentTitle = title;
                                        window.flutter_adeeinappwebview.nativeCommunication('onTitleChanged', viewId, [title]);
                                    }
                                }).observe(
                                    titleEl,
                            ...
                            iframe.contentWindow.addEventListener('resize', function (e) {
                                ...
                                if(newPixelRatio !== oldPixelRatio){
                                    window.flutter_adeeinappwebview.nativeCommunication('onZoomScaleChanged', viewId, [oldPixelRatio, newPixelRatio]);
                            ...
                            iframe.contentWindow.addEventListener('scroll', function (event) {
                                ...
                                window.flutter_adeeinappwebview.nativeCommunication('onScrollChanged', viewId, [x, y]);
                            });

                            iframe.contentWindow.addEventListener('focus', function (event) {
                                window.flutter_adeeinappwebview.nativeCommunication('onWindowFocus', viewId);
                            });

                            iframe.contentWindow.addEventListener('blur', function (event) {
                                window.flutter_adeeinappwebview.nativeCommunication('onWindowBlur', viewId);
                            });
                        } catch (e) {
                            console.log(e);
                        }
                        ...
                        window.flutter_adeeinappwebview.nativeCommunication('onLoadStop', viewId, [url]);
                    });
                }
            },
                ...
                try {
                    ...
                    if (script.id != null) {
                        script.onload = function() {
                            window.flutter_adeeinappwebview.nativeCommunication('onInjectedScriptLoaded', webView.viewId, [script.id]);
                        }
                        script.onerror = function() {
                            window.flutter_adeeinappwebview.nativeCommunication('onInjectedScriptError', webView.viewId, [script.id]);
                        }
                    }
                    script.src = urlFile;
                    if (d.body != null) {
