import 'dart:async';
import 'dart:ui_web';
import '../src/adeeinappwebview_platform.dart';
...
/// Allows assigning a function to be callable from `window.flutter_adeeinappwebview.nativeCommunication()`
@JS('flutter_adeeinappwebview.nativeCommunication')
