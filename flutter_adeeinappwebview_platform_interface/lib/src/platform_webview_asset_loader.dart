...
class PlatformPathHandlerCreationParams {
  ...
  ///{@macro flutter_adeeinappwebview_platform_interface.PlatformPathHandler.path}
  final String path;
}

///{@template flutter_adeeinappwebview_platform_interface.PlatformPathHandler}
...
abstract class PlatformPathHandler {
  ...
  ///{@template flutter_adeeinappwebview_platform_interface.PlatformPathHandler.type}
  ...
  ///{@template flutter_adeeinappwebview_platform_interface.PlatformPathHandler.path}
...
abstract class PlatformPathHandlerEvents {
  ///{@template flutter_adeeinappwebview_platform_interface.PlatformPathHandler.handle}
...
///{@template flutter_adeeinappwebview_platform_interface.PlatformAssetsPathHandler}
...
///{@template flutter_adeeinappwebview_platform_interface.PlatformResourcesPathHandler}
...
///{@template flutter_adeeinappwebview_platform_interface.PlatformInternalStoragePathHandler}
