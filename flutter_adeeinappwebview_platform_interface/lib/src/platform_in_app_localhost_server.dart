...
class PlatformInAppLocalhostServerCreationParams {
  ...
  ///{@macro flutter_adeeinappwebview_platform_interface.PlatformInAppLocalhostServer.port}
  final int port;

  ///{@macro flutter_adeeinappwebview_platform_interface.PlatformInAppLocalhostServer.directoryIndex}
  final String directoryIndex;

  ///{@macro flutter_adeeinappwebview_platform_interface.PlatformInAppLocalhostServer.documentRoot}
  final String documentRoot;

  ///{@macro flutter_adeeinappwebview_platform_interface.PlatformInAppLocalhostServer.shared}
  final bool shared;
}

///{@template flutter_adeeinappwebview_platform_interface.PlatformInAppLocalhostServer}
...
abstract class PlatformInAppLocalhostServer extends PlatformInterface {
  ...
  ///{@template flutter_adeeinappwebview_platform_interface.PlatformInAppLocalhostServer.port}
  ///Represents the port of the server. The default value is `8080`.
  ///{@endtemplate}
  int get port => params.port;

  ///{@template flutter_adeeinappwebview_platform_interface.PlatformInAppLocalhostServer.directoryIndex}
  ///represents the index file to use. The default value is `index.html`.
  ///{@endtemplate}
  String get directoryIndex => params.directoryIndex;

  ///{@template flutter_adeeinappwebview_platform_interface.PlatformInAppLocalhostServer.documentRoot}
  ///Represents the document root path to serve. The default value is `./`.
  ///{@endtemplate}
  String get documentRoot => params.documentRoot;

  ///{@template flutter_adeeinappwebview_platform_interface.PlatformInAppLocalhostServer.shared}
  ...
  ///{@template flutter_adeeinappwebview_platform_interface.PlatformInAppLocalhostServer.start}
  ...
  ///{@template flutter_adeeinappwebview_platform_interface.PlatformInAppLocalhostServer.close}
  ///Closes the server.
  ///{@endtemplate}
  Future<void> close() {
    throw UnimplementedError(
  ...
  ///{@template flutter_adeeinappwebview_platform_interface.PlatformInAppLocalhostServer.isRunning}
