...
///{@template flutter_adeeinappwebview_platform_interface.PlatformHeadlessInAppWebView}
...
abstract class PlatformHeadlessInAppWebView extends PlatformInterface
  ...
  ///{@template flutter_adeeinappwebview_platform_interface.PlatformHeadlessInAppWebView.id}
  ///View ID.
  ///{@endtemplate}
  String get id =>
      throw UnimplementedError('id is not implemented on the current platform');

  ///{@template flutter_adeeinappwebview_platform_interface.PlatformHeadlessInAppWebView.webViewController}
  ...
  ///{@template flutter_adeeinappwebview_platform_interface.PlatformHeadlessInAppWebView.run}
  ...
  ///{@template flutter_adeeinappwebview_platform_interface.PlatformHeadlessInAppWebView.isRunning}
  ...
  ///{@template flutter_adeeinappwebview_platform_interface.PlatformHeadlessInAppWebView.setSize}
  ...
  ///{@template flutter_adeeinappwebview_platform_interface.PlatformHeadlessInAppWebView.getSize}
  ...
  ///{@template flutter_adeeinappwebview_platform_interface.PlatformHeadlessInAppWebView.dispose}
