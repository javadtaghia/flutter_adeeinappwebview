...
class PlatformPrintJobControllerCreationParams {
  ...
  ///{@macro flutter_adeeinappwebview_platform_interface.PlatformPrintJobController.id}
  final String id;

  ///{@macro flutter_adeeinappwebview_platform_interface.PlatformPrintJobController.onComplete}
  final PrintJobCompletionHandler? onComplete;
}

///{@template flutter_adeeinappwebview_platform_interface.PlatformPrintJobController}
...
abstract class PlatformPrintJobController extends PlatformInterface
  ...
  ///{@template flutter_adeeinappwebview_platform_interface.PlatformPrintJobController.id}
  ///Print job ID.
  ///{@endtemplate}
  String get id => params.id;

  ///{@template flutter_adeeinappwebview_platform_interface.PlatformPrintJobController.onComplete}
  ...
  ///{@template flutter_adeeinappwebview_platform_interface.PlatformPrintJobController.cancel}
  ...
  ///{@template flutter_adeeinappwebview_platform_interface.PlatformPrintJobController.restart}
  ...
  ///{@template flutter_adeeinappwebview_platform_interface.PlatformPrintJobController.dismiss}
  ...
  ///{@template flutter_adeeinappwebview_platform_interface.PlatformPrintJobController.getInfo}
  ...
  ///{@template flutter_adeeinappwebview_platform_interface.PlatformPrintJobController.dispose}
