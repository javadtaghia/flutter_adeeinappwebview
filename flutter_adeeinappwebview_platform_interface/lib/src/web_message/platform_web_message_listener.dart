...
class PlatformWebMessageListenerCreationParams {
  ...
  ///{@macro flutter_adeeinappwebview_platform_interface.PlatformWebMessageListener.jsObjectName}
  final String jsObjectName;

  ///{@macro flutter_adeeinappwebview_platform_interface.PlatformWebMessageListener.allowedOriginRules}
  final Set<String>? allowedOriginRules;

  ///{@macro flutter_adeeinappwebview_platform_interface.PlatformWebMessageListener.onPostMessage}
...
///{@template flutter_adeeinappwebview_platform_interface.PlatformWebMessageListener}
...
abstract class PlatformWebMessageListener extends PlatformInterface
  ...
  ///{@template flutter_adeeinappwebview_platform_interface.PlatformWebMessageListener.jsObjectName}
  ///The name for the injected JavaScript object.
  ///{@endtemplate}
  String get jsObjectName => params.jsObjectName;

  ///{@template flutter_adeeinappwebview_platform_interface.PlatformWebMessageListener.allowedOriginRules}
  ///A set of matching rules for the allowed origins.
  ///{@endtemplate}
  Set<String>? get allowedOriginRules => params.allowedOriginRules;

  ///{@template flutter_adeeinappwebview_platform_interface.PlatformWebMessageListener.onPostMessage}
  ...
  ///{@template flutter_adeeinappwebview_platform_interface.PlatformWebMessageListener.dispose}
...
///{@template flutter_adeeinappwebview_platform_interface.PlatformJavaScriptReplyProxy}
...
abstract class PlatformJavaScriptReplyProxy extends PlatformInterface {
  ...
  ///{@template flutter_adeeinappwebview_platform_interface.PlatformJavaScriptReplyProxy.postMessage}
