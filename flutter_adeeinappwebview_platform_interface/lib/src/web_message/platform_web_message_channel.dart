...
class PlatformWebMessageChannelCreationParams {
  ...
  ///{@macro flutter_adeeinappwebview_platform_interface.PlatformWebMessageChannel.id}
  final String id;

  ///{@macro flutter_adeeinappwebview_platform_interface.PlatformWebMessageChannel.port1}
  final PlatformWebMessagePort port1;

  ///{@macro flutter_adeeinappwebview_platform_interface.PlatformWebMessageChannel.port2}
...
///{@template flutter_adeeinappwebview_platform_interface.PlatformWebMessageChannel}
...
abstract class PlatformWebMessageChannel extends PlatformInterface
  ...
  ///{@template flutter_adeeinappwebview_platform_interface.PlatformWebMessageChannel.id}
  ///Message Channel ID used internally.
  ///{@endtemplate}
  String get id => params.id;

  ///{@template flutter_adeeinappwebview_platform_interface.PlatformWebMessageChannel.port1}
  ///The first [PlatformWebMessagePort] object of the channel.
  ///{@endtemplate}
  PlatformWebMessagePort get port1 => params.port1;

  ///{@template flutter_adeeinappwebview_platform_interface.PlatformWebMessageChannel.port2}
