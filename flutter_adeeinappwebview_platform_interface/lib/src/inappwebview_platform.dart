...
abstract class InAppWebViewPlatform extends PlatformInterface {
  ...
  ///
  /// This function should only be called by the app-facing package.
  /// Look at using [PullToRefreshController] in `flutter_adeeinappwebview` instead.
  ...
  ///
  /// This function should only be called by the app-facing package.
  /// Look at using [WebStorage] in `flutter_adeeinappwebview` instead.
  ...
  ///
  /// This function should only be called by the app-facing package.
  /// Look at using [LocalStorage] in `flutter_adeeinappwebview` instead.
  ...
  ///
  /// This function should only be called by the app-facing package.
  /// Look at using [ProcessGlobalConfig] in `flutter_adeeinappwebview` instead.
  ...
  ///
  /// This function should only be called by the app-facing package.
  /// Look at using [ProxyController] in `flutter_adeeinappwebview` instead.
  ...
  ///
  /// This function should only be called by the app-facing package.
  /// Look at using [ServiceWorkerController] in `flutter_adeeinappwebview` instead.
  ...
  ///
  /// This function should only be called by the app-facing package.
  /// Look at using [TracingController] in `flutter_adeeinappwebview` instead.
  ...
  ///
  /// This function should only be called by the app-facing package.
  /// Look at using [AssetsPathHandler] in `flutter_adeeinappwebview` instead.
  ...
  ///
  /// This function should only be called by the app-facing package.
  /// Look at using [ResourcesPathHandler] in `flutter_adeeinappwebview` instead.
  ...
  ///
  /// This function should only be called by the app-facing package.
  /// Look at using [InternalStoragePathHandler] in `flutter_adeeinappwebview` instead.
  ...
  ///
  /// This function should only be called by the app-facing package.
  /// Look at using [WebViewFeature] in `flutter_adeeinappwebview` instead.
  ...
  ///
  /// This function should only be called by the app-facing package.
  /// Look at using [DefaultInAppLocalhostServer] in `flutter_adeeinappwebview` instead.
  ...
  ///
  /// This function should only be called by the app-facing package.
  /// Look at using [ChromeSafariBrowser] in `flutter_adeeinappwebview` instead.
