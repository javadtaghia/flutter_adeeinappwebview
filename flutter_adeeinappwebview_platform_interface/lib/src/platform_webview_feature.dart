...
///{@template flutter_adeeinappwebview_platform_interface.PlatformWebViewFeature}
...
abstract class PlatformWebViewFeature extends PlatformInterface {
  ...
  ///{@template flutter_adeeinappwebview_platform_interface.PlatformWebViewFeature.isFeatureSupported}
  ...
  ///{@template flutter_adeeinappwebview_platform_interface.PlatformWebViewFeature.isStartupFeatureSupported}
...
///{@macro flutter_adeeinappwebview_platform_interface.PlatformWebViewFeature}
@ExchangeableEnum()
class WebViewFeature_ {
  ...
  ///{@macro flutter_adeeinappwebview_platform_interface.PlatformWebViewFeature.isFeatureSupported}
  static Future<bool> isFeatureSupported(WebViewFeature feature) =>
      PlatformWebViewFeature.static().isFeatureSupported(feature);

  ///{@macro flutter_adeeinappwebview_platform_interface.PlatformWebViewFeature.isStartupFeatureSupported}
