...
class PlatformWebStorageCreationParams {
  ...
  ///{@macro flutter_adeeinappwebview_platform_interface.PlatformWebStorage.localStorage}
  final PlatformLocalStorage localStorage;

  ///{@macro flutter_adeeinappwebview_platform_interface.PlatformWebStorage.sessionStorage}
  final PlatformSessionStorage sessionStorage;
}

///{@template flutter_adeeinappwebview_platform_interface.PlatformWebStorage}
...
abstract class PlatformWebStorage extends PlatformInterface
  ...
  ///{@template flutter_adeeinappwebview_platform_interface.PlatformWebStorage.localStorage}
  ///Represents `window.localStorage`.
  ///{@endtemplate}
  PlatformLocalStorage get localStorage => params.localStorage;

  ///{@template flutter_adeeinappwebview_platform_interface.PlatformWebStorage.sessionStorage}
  ///Represents `window.sessionStorage`.
  ///{@endtemplate}
  PlatformSessionStorage get sessionStorage => params.sessionStorage;

  ///{@template flutter_adeeinappwebview_platform_interface.PlatformWebStorage.dispose}
...
class PlatformStorageCreationParams {
  ...
  ///{@macro flutter_adeeinappwebview_platform_interface.PlatformStorage.controller}
  final PlatformInAppWebViewController? controller;

  ///{@macro flutter_adeeinappwebview_platform_interface.PlatformStorage.webStorageType}
  final WebStorageType webStorageType;
}

///{@template flutter_adeeinappwebview_platform_interface.PlatformStorage}
...
abstract class PlatformStorage implements Disposable {
  ///{@template flutter_adeeinappwebview_platform_interface.PlatformStorage.controller}
  ///Controller used to interact with storage.
  ///{@endtemplate}
  PlatformInAppWebViewController? get controller;

  ///{@template flutter_adeeinappwebview_platform_interface.PlatformStorage.webStorageType}
  ...
  ///{@template flutter_adeeinappwebview_platform_interface.PlatformStorage.length}
  ...
  ///{@template flutter_adeeinappwebview_platform_interface.PlatformStorage.setItem}
  ...
  ///{@template flutter_adeeinappwebview_platform_interface.PlatformStorage.getItem}
  ...
  ///{@template flutter_adeeinappwebview_platform_interface.PlatformStorage.removeItem}
  ...
  ///{@template flutter_adeeinappwebview_platform_interface.PlatformStorage.getItems}
  ...
  ///{@template flutter_adeeinappwebview_platform_interface.PlatformStorage.clear}
  ...
  ///{@template flutter_adeeinappwebview_platform_interface.PlatformStorage.key}
...
///{@template flutter_adeeinappwebview_platform_interface.PlatformLocalStorage}
...
///{@template flutter_adeeinappwebview_platform_interface.PlatformSessionStorage}
