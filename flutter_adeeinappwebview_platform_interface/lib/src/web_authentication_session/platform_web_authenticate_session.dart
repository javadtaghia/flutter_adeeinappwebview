...
///{@template flutter_adeeinappwebview_platform_interface.PlatformWebAuthenticationSession}
...
abstract class PlatformWebAuthenticationSession extends PlatformInterface
  ...
  ///{@template flutter_adeeinappwebview_platform_interface.PlatformWebAuthenticationSession.id}
  ///ID used internally.
  ///{@endtemplate}
  String get id =>
      throw UnimplementedError('id is not implemented on the current platform');

  ///{@template flutter_adeeinappwebview_platform_interface.PlatformWebAuthenticationSession.url}
  ...
  ///{@template flutter_adeeinappwebview_platform_interface.PlatformWebAuthenticationSession.callbackURLScheme}
  ...
  ///{@template flutter_adeeinappwebview_platform_interface.PlatformWebAuthenticationSession.initialSettings}
  ///Initial settings.
  ///{@endtemplate}
  ...
  ///{@template flutter_adeeinappwebview_platform_interface.PlatformWebAuthenticationSession.onComplete}
  ...
  ///{@template flutter_adeeinappwebview_platform_interface.PlatformWebAuthenticationSession.create}
  ...
  ///{@template flutter_adeeinappwebview_platform_interface.PlatformWebAuthenticationSession.canStart}
  ...
  ///{@template flutter_adeeinappwebview_platform_interface.PlatformWebAuthenticationSession.start}
  ...
  ///{@template flutter_adeeinappwebview_platform_interface.PlatformWebAuthenticationSession.cancel}
  ...
  ///{@template flutter_adeeinappwebview_platform_interface.PlatformWebAuthenticationSession.dispose}
  ...
  ///{@template flutter_adeeinappwebview_platform_interface.PlatformWebAuthenticationSession.isAvailable}
