...
class PlatformPullToRefreshControllerCreationParams {
  ...
  ///{@macro flutter_adeeinappwebview_platform_interface.PlatformPullToRefreshController.options}
  @Deprecated("Use settings instead")
  late PullToRefreshOptions options;

  ///{@macro flutter_adeeinappwebview_platform_interface.PlatformPullToRefreshController.settings}
  late PullToRefreshSettings settings;

  ///{@macro flutter_adeeinappwebview_platform_interface.PlatformPullToRefreshController.onRefresh}
  final void Function()? onRefresh;
}

///{@template flutter_adeeinappwebview_platform_interface.PlatformPullToRefreshController}
...
abstract class PlatformPullToRefreshController extends PlatformInterface
  ...
  ///{@template flutter_adeeinappwebview_platform_interface.PlatformPullToRefreshController.options}
  /// Use [settings] instead.
  ///{@endtemplate}
  @Deprecated("Use settings instead")
  PullToRefreshOptions get options => params.options;

  ///{@template flutter_adeeinappwebview_platform_interface.PlatformPullToRefreshController.settings}
  /// Initial settings.
  ///{@endtemplate}
  PullToRefreshSettings get settings => params.settings;

  ///{@template flutter_adeeinappwebview_platform_interface.PlatformPullToRefreshController.onRefresh}
  ///Event called when a swipe gesture triggers a refresh.
  ///{@endtemplate}
  void Function()? get onRefresh => params.onRefresh;

  ///{@template flutter_adeeinappwebview_platform_interface.PlatformPullToRefreshController.setEnabled}
  ...
  ///{@template flutter_adeeinappwebview_platform_interface.PlatformPullToRefreshController.isEnabled}
  ...
  ///{@template flutter_adeeinappwebview_platform_interface.PlatformPullToRefreshController.beginRefreshing}
  ...
  ///{@template flutter_adeeinappwebview_platform_interface.PlatformPullToRefreshController.endRefreshing}
  ...
  ///{@template flutter_adeeinappwebview_platform_interface.PlatformPullToRefreshController.isRefreshing}
  ...
  ///{@template flutter_adeeinappwebview_platform_interface.PlatformPullToRefreshController.setColor}
  ...
  ///{@template flutter_adeeinappwebview_platform_interface.PlatformPullToRefreshController.setBackgroundColor}
  ...
  ///{@template flutter_adeeinappwebview_platform_interface.PlatformPullToRefreshController.setDistanceToTriggerSync}
  ...
  ///{@template flutter_adeeinappwebview_platform_interface.PlatformPullToRefreshController.setSlingshotDistance}
  ...
  ///{@template flutter_adeeinappwebview_platform_interface.PlatformPullToRefreshController.getDefaultSlingshotDistance}
  ...
  ///{@template flutter_adeeinappwebview_platform_interface.PlatformPullToRefreshController.setSize}
  ...
  ///{@template flutter_adeeinappwebview_platform_interface.PlatformPullToRefreshController.setIndicatorSize}
  ...
  ///{@template flutter_adeeinappwebview_platform_interface.PlatformPullToRefreshController.setAttributedTitle}
  ...
  ///{@template flutter_adeeinappwebview_platform_interface.PlatformPullToRefreshController.setStyledTitle}
  ...
  ///{@template flutter_adeeinappwebview_platform_interface.PlatformPullToRefreshController.dispose}
