...
class MacOSWebMessageListener extends PlatformWebMessageListener
  ...
  MacOSWebMessageListener(PlatformWebMessageListenerCreationParams params)
    ...
    channel = MethodChannel(
        'com.pichillilorenzo/flutter_adeeinappwebview_web_message_listener_${_id}_${params.jsObjectName}');
...
///{@macro flutter_adeeinappwebview_platform_interface.JavaScriptReplyProxy}
