...
public class ServiceWorkerManager implements Disposable {
  ...
  public static final String METHOD_CHANNEL_NAME = "com.pichillilorenzo/flutter_adeeinappwebview_serviceworkercontroller";
  ...
  public void setServiceWorkerClient(Boolean isNull) {
    if (serviceWorkerController != null) {
      ...
      // https://github.com/javadtaghia/flutter_adeeinappwebview/issues/1151
