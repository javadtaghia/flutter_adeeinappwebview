...
public interface InAppWebViewInterface {
  ...
  void postWebMessage(com.pichillilorenzo.flutter_adeeinappwebview_android.types.WebMessage message, Uri targetOrigin, ValueCallback<String> callback) throws Exception;
