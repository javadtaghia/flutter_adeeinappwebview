package com.pichillilorenzo.flutter_adeeinappwebview_android.plugin_scripts_js;

import com.pichillilorenzo.flutter_adeeinappwebview_android.types.PluginScript;
import com.pichillilorenzo.flutter_adeeinappwebview_android.types.UserScriptInjectionTime;
...
public class InterceptAjaxRequestJS {
  ...
  public static final String INTERCEPT_AJAX_REQUEST_JS_SOURCE = "(function(ajax) {" +
          ...
          "  ajax.prototype._flutter_adeeinappwebview_url = null;" +
          "  ajax.prototype._flutter_adeeinappwebview_method = null;" +
          "  ajax.prototype._flutter_adeeinappwebview_isAsync = null;" +
          "  ajax.prototype._flutter_adeeinappwebview_user = null;" +
          "  ajax.prototype._flutter_adeeinappwebview_password = null;" +
          "  ajax.prototype._flutter_adeeinappwebview_password = null;" +
          "  ajax.prototype._flutter_adeeinappwebview_already_onreadystatechange_wrapped = false;" +
          "  ajax.prototype._flutter_adeeinappwebview_request_headers = {};" +
          ...
          "    this._flutter_adeeinappwebview_url = url;" +
          "    this._flutter_adeeinappwebview_method = method;" +
          "    this._flutter_adeeinappwebview_isAsync = isAsync;" +
          "    this._flutter_adeeinappwebview_user = user;" +
          "    this._flutter_adeeinappwebview_password = password;" +
          "    this._flutter_adeeinappwebview_request_headers = {};" +
          "    open.call(this, method, url, isAsync, user, password);" +
          "  };" +
          "  ajax.prototype.setRequestHeader = function(header, value) {" +
          "    this._flutter_adeeinappwebview_request_headers[header] = value;" +
          ...
          "        var ajaxRequest = {" +
          "          method: self._flutter_adeeinappwebview_method," +
          "          url: self._flutter_adeeinappwebview_url," +
          "          isAsync: self._flutter_adeeinappwebview_isAsync," +
          "          user: self._flutter_adeeinappwebview_user," +
          "          password: self._flutter_adeeinappwebview_password," +
          "          withCredentials: self.withCredentials," +
          "          headers: self._flutter_adeeinappwebview_request_headers," +
          ...
          "    var w = (window.top == null || window.top === window) ? window : window.top;" +
          "    if (w." + FLAG_VARIABLE_FOR_SHOULD_INTERCEPT_AJAX_REQUEST_JS_SOURCE + " == null || w." + FLAG_VARIABLE_FOR_SHOULD_INTERCEPT_AJAX_REQUEST_JS_SOURCE + " == true) {" +
          "      if (!this._flutter_adeeinappwebview_already_onreadystatechange_wrapped) {" +
          "        this._flutter_adeeinappwebview_already_onreadystatechange_wrapped = true;" +
          ...
          "              var flutter_adeeinappwebview_value = self._flutter_adeeinappwebview_request_headers[header];" +
          "              if (flutter_adeeinappwebview_value == null) {" +
          "                self._flutter_adeeinappwebview_request_headers[header] = value;" +
          "              } else {" +
          "                self._flutter_adeeinappwebview_request_headers[header] += ', ' + value;" +
          "              }" +
          "              setRequestHeader.call(self, header, value);" +
          "            };" +
          "            if ((self._flutter_adeeinappwebview_method != result.method && result.method != null) || (self._flutter_adeeinappwebview_url != result.url && result.url != null)) {" +
          "              self.abort();" +
