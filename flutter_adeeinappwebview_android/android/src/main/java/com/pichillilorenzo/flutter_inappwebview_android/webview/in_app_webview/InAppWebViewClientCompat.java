...
import com.pichillilorenzo.flutter_adeeinappwebview_android.credential_database.CredentialDatabase;
...
import com.pichillilorenzo.flutter_adeeinappwebview_android.types.URLCredential;
import com.pichillilorenzo.flutter_adeeinappwebview_android.types.URLProtectionSpace;
...
public class InAppWebViewClientCompat extends WebViewClientCompat {
  ...
  public void onSafeBrowsingHit(@NonNull final WebView view,
    ...
    final WebViewChannelDelegate.SafeBrowsingHitCallback resultCallback = new WebViewChannelDelegate.SafeBrowsingHitCallback() {
      @Override
      public boolean nonNullSuccess(@NonNull com.pichillilorenzo.flutter_adeeinappwebview_android.types.SafeBrowsingResponse response) {
        Integer action = response.getAction();
        if (action != null) {
      ...
      @Override
      public void defaultBehaviour(@Nullable com.pichillilorenzo.flutter_adeeinappwebview_android.types.SafeBrowsingResponse result) {
