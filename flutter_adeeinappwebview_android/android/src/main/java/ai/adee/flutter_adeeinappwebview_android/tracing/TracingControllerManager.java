package ai.adee.flutter_adeeinappwebview_android.tracing;
...
public class TracingControllerManager implements Disposable {
  ...
  public static final String METHOD_CHANNEL_NAME = "ai.adee/flutter_adeeinappwebview_tracingcontroller";
